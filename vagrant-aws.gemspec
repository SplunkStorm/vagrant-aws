...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "excon", "0.25.3"
  s.add_development_dependency "fog", "1.10.1"
  s.add_development_dependency "formatador", "0.2.4"
  s.add_development_dependency "mime-types", "1.25"
  s.add_development_dependency "multi_json", "1.8.0"
  s.add_development_dependency "net-scp", "1.1.2"
  s.add_development_dependency "net-ssh", "2.6.6"
